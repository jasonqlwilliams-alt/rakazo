...
import { botCreateInput } from "../lib/bot-fields";
import {
...
export function ShellPage() {
  ...
  async function createBot(input: {
    ...
    // botCreateInput keeps the description blurb out of the persona field; the
    // upstream normalizer copies one into the other, which is the defect that
    // overwrote every seat's instructions with its short description.
